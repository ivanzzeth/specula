...
-- The repos table already exists (0002_multitenant). A dedicated repo_tags
-- table (rather than reusing the mutable metadata tier) keeps ListTags a simple
...
-- SQL runs verbatim on SQLite and PostgreSQL. Idempotent (IF NOT EXISTS).
